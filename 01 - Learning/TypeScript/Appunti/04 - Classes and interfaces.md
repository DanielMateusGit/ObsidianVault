- [[#Classi per OOP|Classi per OOP]]
- [[#Modificatori di accesso|Modificatori di accesso]]
- [[#Costruttore "slim"|Costruttore "slim"]]
- [[#Proprietà readonly|Proprietà readonly]]
- [[#Esempio di quanto visto fino ad ora|Esempio di quanto visto fino ad ora]]
- [[#Ereditarietà|Ereditarietà]]
- [[#Classi Astratte|Classi Astratte]]
- [[#Costruttori privati e Singleton|Costruttori privati e Singleton]]
...
> [!Warning] Attenzione!
> Le classi in JS non sono davvero classi. Le classi in JS sono funzioni. 
> Infatti, prima della version es6, esistevano solo le funzioni di costruzione.
> 
...
L' ereditarietà è la classica dell' OOP.
