...
tags:
  ...
  - WebDev
---
- [[#Quali sono i tipi primitivi?|Quali sono i tipi primitivi?]]
- [[#Come definisco oggetti?|Come definisco oggetti?]]
- [[#Come definisco un array?|Come definisco un array?]]
- [[#Come definisco delle Tuple?|Come definisco delle Tuple?]]
- [[#Come definisco degli enum?|Come definisco degli enum?]]
- [[#Come attivo il comportamento di default?|Come attivo il comportamento di default?]]
- [[#Union Types|Union Types]]
- [[#Literal Types|Literal Types]]
- [[#Aliases|Aliases]]
- [[#Return delle funzioni|Return delle funzioni]]
- [[#Funzioni e Callbacks|Funzioni e Callbacks]]
...
> Ad esempio:
> 
> Se ho un array di string ogni oggetto potrà invocare il metodo toUpperCase().
> Invece avendo un array di interi, la chiamata .toUpperCase() genererà un errore.

***
## Come definisco delle Tuple?

Le tuple sono array con una dimensione e celle con tipi fissati (non necessariamente uguali).

> [!Warning] Cosa si intende per tipo fissato
> Ogni elemento dell' array ha un tipo specifico, deciso durante la dichiarazione della tupla. Posso però specificare un tipo per "cella" (è fissato nel senso che poi non potrò cambiarlo)
> 
...
Il tipo any è quello di default di Javascript.
Dichiarando un dato con questo tipo, perdiamo la tipizzazione di Typescript.

È solamente possibile specificare se un dato conterrà un dato singolo (any) oppure un array (any[])

```typescript
const arrayWithoutTypeCheck : any[]  = ["Hello", 10, true];
```
...
Sono tipi contenti i valori "veri e propri", assumibili da un dato.
Ad esempio:
